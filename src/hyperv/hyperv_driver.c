                     ...
                     char *username, char *password)
{
    ...
    virBufferAddLit(&wqlQuery.query, MSVM_COMPUTERSYSTEM_WQL_SELECT);
    virBufferAddLit(&wqlQuery.query, "WHERE ");
    virBufferAddLit(&wqlQuery.query, MSVM_COMPUTERSYSTEM_WQL_PHYSICAL);
