...
enum remote_procedure {
     ...
     */
    REMOTE_PROC_NETWORK_PORT_GET_PARAMETERS = 406,

    /**
     * @generate: both
     * @acl: network_port:write
     */
    REMOTE_PROC_NETWORK_PORT_SET_PARAMETERS = 407,

    /**
     * @generate: both
     * @acl: network_port:read
     */
    REMOTE_PROC_NETWORK_PORT_GET_XML_DESC = 408,

    /**
     * @generate: both
     * @acl: network_port:delete
     */
    REMOTE_PROC_NETWORK_PORT_DELETE = 409
