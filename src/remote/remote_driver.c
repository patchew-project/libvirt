...
static virNetworkDriver network_driver = {
    ...
    .networkListAllPorts = remoteNetworkListAllPorts, /* 5.2.0 */
    .networkPortLookupByUUID = remoteNetworkPortLookupByUUID, /* 5.2.0 */
    .networkPortCreateXML = remoteNetworkPortCreateXML, /* 5.2.0 */
    .networkPortGetXMLDesc = remoteNetworkPortGetXMLDesc, /* 5.2.0 */
    .networkPortSetParameters = remoteNetworkPortSetParameters, /* 5.2.0 */
    .networkPortGetParameters = remoteNetworkPortGetParameters, /* 5.2.0 */
    .networkPortDelete = remoteNetworkPortDelete, /* 5.2.0 */
};
