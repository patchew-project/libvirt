...
static virNWFilterDriver nwfilter_driver = {
    ...
    .connectListAllNWFilterBindings = remoteConnectListAllNWFilterBindings, /* 4.4.0 */
    .nwfilterBindingLookupByPortDev = remoteNWFilterBindingLookupByPortDev, /* 4.4.0 */
    .nwfilterBindingCreateXML = remoteNWFilterBindingCreateXML, /* 4.4.0 */
    .nwfilterBindingDelete = remoteNWFilterBindingDelete, /* 4.4.0 */
    .nwfilterBindingGetXMLDesc = remoteNWFilterBindingGetXMLDesc, /* 4.4.0 */
};
