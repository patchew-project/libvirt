...
static virHypervisorDriver hypervisor_driver = {
    ...
    .domainListAllCheckpoints = remoteDomainListAllCheckpoints, /* 5.2.0 */
    .domainCheckpointListAllChildren = remoteDomainCheckpointListAllChildren, /* 5.2.0 */
    ...
    .domainSnapshotCreateXML2 = remoteDomainSnapshotCreateXML2, /* 5.2.0 */
};
