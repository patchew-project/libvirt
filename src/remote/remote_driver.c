...
static virNetworkDriver network_driver = {
    ...
    .networkListAllPorts = remoteNetworkListAllPorts, /* 5.3.0 */
    .networkPortLookupByUUID = remoteNetworkPortLookupByUUID, /* 5.3.0 */
    .networkPortCreateXML = remoteNetworkPortCreateXML, /* 5.3.0 */
    .networkPortGetXMLDesc = remoteNetworkPortGetXMLDesc, /* 5.3.0 */
    .networkPortSetParameters = remoteNetworkPortSetParameters, /* 5.3.0 */
    .networkPortGetParameters = remoteNetworkPortGetParameters, /* 5.3.0 */
    .networkPortDelete = remoteNetworkPortDelete, /* 5.3.0 */
};
