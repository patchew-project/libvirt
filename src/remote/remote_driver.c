...
static virHypervisorDriver hypervisor_driver = {
    ...
    .domainCheckpointCreateXML = remoteDomainCheckpointCreateXML, /* 5.5.0 */
    .domainCheckpointGetXMLDesc = remoteDomainCheckpointGetXMLDesc, /* 5.5.0 */
    .domainListAllCheckpoints = remoteDomainListAllCheckpoints, /* 5.5.0 */
    .domainCheckpointListAllChildren = remoteDomainCheckpointListAllChildren, /* 5.5.0 */
    .domainCheckpointLookupByName = remoteDomainCheckpointLookupByName, /* 5.5.0 */
    .domainCheckpointGetParent = remoteDomainCheckpointGetParent, /* 5.5.0 */
    .domainCheckpointCurrent = remoteDomainCheckpointCurrent, /* 5.5.0 */
    .domainCheckpointIsCurrent = remoteDomainCheckpointIsCurrent, /* 5.5.0 */
    .domainCheckpointDelete = remoteDomainCheckpointDelete, /* 5.5.0 */
};
