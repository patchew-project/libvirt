...
static virHypervisorDriver qemuHypervisorDriver = {
    ...
    .domainCheckpointCreateXML = qemuDomainCheckpointCreateXML, /* 5.5.0 */
    .domainCheckpointGetXMLDesc = qemuDomainCheckpointGetXMLDesc, /* 5.5.0 */

    .domainListAllCheckpoints = qemuDomainListAllCheckpoints, /* 5.5.0 */
    .domainCheckpointListAllChildren = qemuDomainCheckpointListAllChildren, /* 5.5.0 */
    .domainCheckpointLookupByName = qemuDomainCheckpointLookupByName, /* 5.5.0 */
    .domainCheckpointGetParent = qemuDomainCheckpointGetParent, /* 5.5.0 */
    .domainCheckpointCurrent = qemuDomainCheckpointCurrent, /* 5.5.0 */
    .domainCheckpointIsCurrent = qemuDomainCheckpointIsCurrent, /* 5.5.0 */
    .domainCheckpointDelete = qemuDomainCheckpointDelete, /* 5.5.0 */
};
