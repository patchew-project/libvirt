                      ...
                      const char *devPath)
{
    ...
    return qemuDomainCreateDevice(mem->path, devPath, false);
}
                               ...
                               virDomainMemoryDefPtr mem)
{
    ...
    if (qemuDomainAttachDeviceMknod(driver, vm, mem->path) < 0)
        goto cleanup;
    ret = 0;
 cleanup:
    return ret;
                                  ...
                                  virDomainMemoryDefPtr mem)
{
    ...
    if (qemuDomainDetachDeviceUnlink(driver, vm, mem->path) < 0)
        goto cleanup;
    ret = 0;
 cleanup:
    return ret;
