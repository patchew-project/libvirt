                           ...
                           bool async)
{
    ...
    case VIR_DOMAIN_DEVICE_CHR:
        ...
        /*
         * The rest of the device types (that support hot unplug)
         * follow a very similar pattern - First we call type-specific
         * functions to 1) locate the device we want to detach (based
         * on the prototype device in match) and 2) do any
         * device-type-specific validation to assure it is okay to
         * detach the device.
         */
    case VIR_DOMAIN_DEVICE_DISK:
