                                ...
                                qemuDomainObjPrivatePtr priv)
{
    ...
    chardev_alias = qemuDomainGetVhostUserAlias(fs->info.alias);
                        ...
                        virQEMUCapsPtr qemuCaps)
{
    ...
    if (video->type == VIR_DOMAIN_VIDEO_TYPE_QXL) {
        ...
        g_autofree char *alias = qemuDomainGetVhostUserAlias(video->info.alias);
        if (video->heads)
            virBufferAsprintf(&buf, ",max_outputs=%u", video->heads);
...
qemuBuildVhostUserChardevStr(const char *alias,
                             ...
                             virCommandPtr cmd)
{
    g_autofree char *chardev_alias = qemuDomainGetVhostUserAlias(alias);
    char *chardev = NULL;
