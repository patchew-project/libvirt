...
struct _virDomainMemtune {
    ...
    virDomainMemorySource source; /* enum virDomainMemorySource */
    virDomainMemoryAccess access; /* enum virDomainMemoryAccess */
    virDomainMemoryAllocation allocation; /* enum virDomainMemoryAllocation */
};
