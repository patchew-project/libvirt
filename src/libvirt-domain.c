 ...
 *
 *      "users.count" - the number of active users on this domain as an
 *                      unsigned int
 *      "users.<num>.name - username of the user as a string
 *      "users.<num>.domain - domain of the user as a string (may only be
 *                            present on certain guest types)
 *      "users.<num>.login_time - the login time of a user in milliseconds
