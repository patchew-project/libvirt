                             ...
                             ...)
{
    ...
    va_start(ap, type);
    ret = virTypedParameterAssignValueAP(param, type, ap, copystr);
    va_end(ap);
...
int
virTypedParamListAddI(virTypedParamListPtr list,
                      int value,
                      const char *namefmt,
                      ...)
{
...
int
virTypedParamListAddUI(virTypedParamListPtr list,
                       unsigned int value,
                       const char *namefmt,
                       ...)
{
...
int
virTypedParamListAddLL(virTypedParamListPtr list,
                       long long value,
                       const char *namefmt,
                       ...)
{
...
int
virTypedParamListAddULL(virTypedParamListPtr list,
...
int
virTypedParamListAddS(virTypedParamListPtr list,
                      const char *value,
                      const char *namefmt,
                      ...)
{
...
int
virTypedParamListAddB(virTypedParamListPtr list,
                      bool value,
                      const char *namefmt,
                      ...)
{
...
int
virTypedParamListAddD(virTypedParamListPtr list,
                      double value,
                      const char *namefmt,
                      ...)
{
