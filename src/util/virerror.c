...
#undef __VIR_ERROR_ALLOW_INCLUDE_PRIV_H__
...
const virErrorMsgTuple virErrorMsgStrings[VIR_ERR_NUMBER_LAST] = {
    ...
    [VIR_ERR_INVALID_STORAGE_POOL] = MSG("invalid storage pool pointer in", " %s"),
    [VIR_ERR_INVALID_STORAGE_VOL] = MSG("invalid storage volume pointer in", " %s"),
    [VIR_WAR_NO_STORAGE] = MSG("Failed to find a storage driver", ": %s"),
    [VIR_ERR_NO_STORAGE_POOL] = MSG("Storage pool not found", ": %s"),
    [VIR_ERR_NO_STORAGE_VOL] = MSG("Storage volume not found", ": %s"),
    [VIR_WAR_NO_NODE] = MSG("Failed to find a node driver", ": %s"),
    [VIR_ERR_INVALID_NODE_DEVICE] = MSG("invalid node device pointer", " in %s"),
    [VIR_ERR_NO_NODE_DEVICE] = MSG("Node device not found", ": %s"),
    [VIR_ERR_NO_SECURITY_MODEL] = MSG("Security model not found", ": %s"),
    [VIR_ERR_OPERATION_INVALID] = MSG("Requested operation is not valid", ": %s"),
    [VIR_WAR_NO_INTERFACE] = MSG("Failed to find the interface", ": %s"),
    [VIR_ERR_NO_INTERFACE] = MSG("Interface not found", ": %s"),
    [VIR_ERR_INVALID_INTERFACE] = MSG("invalid interface pointer in", " %s"),
    [VIR_ERR_MULTIPLE_INTERFACES] = MSG("multiple matching interfaces found", ": %s"),
    [VIR_WAR_NO_NWFILTER] = MSG("Failed to start the nwfilter driver", ": %s"),
    [VIR_ERR_INVALID_NWFILTER] = MSG("Invalid network filter", ": %s"),
    [VIR_ERR_NO_NWFILTER] = MSG("Network filter not found", ": %s"),
    [VIR_ERR_BUILD_FIREWALL] = MSG("Error while building firewall", ": %s"),
    [VIR_WAR_NO_SECRET] = MSG("Failed to find a secret storage driver", ": %s"),
    [VIR_ERR_INVALID_SECRET] = MSG("Invalid secret", ": %s"),
    [VIR_ERR_NO_SECRET] = MSG("Secret not found", ": %s"),
    [VIR_ERR_CONFIG_UNSUPPORTED] = MSG("unsupported configuration", ": %s"),
    [VIR_ERR_OPERATION_TIMEOUT] = MSG("Timed out during operation", ": %s"),
    [VIR_ERR_MIGRATE_PERSIST_FAILED] = MSG("Failed to make domain persistent after migration", ": %s"),
    [VIR_ERR_HOOK_SCRIPT_FAILED] = MSG("Hook script execution failed", ": %s"),
    [VIR_ERR_INVALID_DOMAIN_SNAPSHOT] = MSG("Invalid snapshot", ": %s"),
    [VIR_ERR_NO_DOMAIN_SNAPSHOT] = MSG("Domain snapshot not found", ": %s"),
    [VIR_ERR_INVALID_STREAM] = MSG("invalid stream pointer", " in %s"),
    [VIR_ERR_ARGUMENT_UNSUPPORTED] = MSG("argument unsupported", ": %s"),
    [VIR_ERR_STORAGE_PROBE_FAILED] = MSG("Storage pool probe failed", ": %s"),
    [VIR_ERR_STORAGE_POOL_BUILT] = MSG("Storage pool already built", ": %s"),
    [VIR_ERR_SNAPSHOT_REVERT_RISKY] = MSG("revert requires force", ": %s"),
    [VIR_ERR_OPERATION_ABORTED] = MSG("operation aborted", ": %s"),
    [VIR_ERR_AUTH_CANCELLED] = MSG("authentication cancelled", ": %s"),
    [VIR_ERR_NO_DOMAIN_METADATA] = MSG("metadata not found", ": %s"),
    [VIR_ERR_MIGRATE_UNSAFE] = MSG("Unsafe migration", ": %s"),
    [VIR_ERR_OVERFLOW] = MSG("numerical overflow", ": %s"),
    [VIR_ERR_BLOCK_COPY_ACTIVE] = MSG("block copy still active", ": %s"),
    [VIR_ERR_OPERATION_UNSUPPORTED] = MSG("Operation not supported", ": %s"),
    [VIR_ERR_SSH] = MSG("SSH transport error", ": %s"),
    [VIR_ERR_AGENT_UNRESPONSIVE] = MSG("Guest agent is not responding", ": %s"),
    [VIR_ERR_RESOURCE_BUSY] = MSG("resource busy", ": %s"),
    [VIR_ERR_ACCESS_DENIED] = MSG("access denied", ": %s"),
    [VIR_ERR_DBUS_SERVICE] = MSG("error from service", ": %s"),
    [VIR_ERR_STORAGE_VOL_EXIST] = MSG_EXISTS("storage volume"),
    [VIR_ERR_CPU_INCOMPATIBLE] = MSG("the CPU is incompatible with host CPU", ": %s"),
    [VIR_ERR_XML_INVALID_SCHEMA] = MSG("XML document failed to validate against schema", ": %s"),
    [VIR_ERR_MIGRATE_FINISH_OK] = MSG("migration successfully aborted", ": %s"),
    [VIR_ERR_AUTH_UNAVAILABLE] = MSG("authentication unavailable", ": %s"),
    [VIR_ERR_NO_SERVER] = MSG("Server not found", ": %s"),
    [VIR_ERR_NO_CLIENT] = MSG("Client not found", ": %s"),
    [VIR_ERR_AGENT_UNSYNCED] = MSG("guest agent replied with wrong id to guest-sync command", ": %s"),
    [VIR_ERR_LIBSSH] = MSG("libssh transport error", ": %s"),
    [VIR_ERR_DEVICE_MISSING] = MSG("device not found", ": %s"),
    [VIR_ERR_INVALID_NWFILTER_BINDING] = MSG("Invalid network filter binding", ": %s"),
    [VIR_ERR_NO_NWFILTER_BINDING] = MSG("Network filter binding not found", ": %s"),
};
