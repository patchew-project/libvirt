...
VIR_ENUM_IMPL(virPerfEvent, VIR_PERF_EVENT_LAST,
              ...
              "cache_l1dwm", "cache_l1dpa", "cache_l1dpm");
...
# endif
    ...
    {.type = VIR_PERF_EVENT_CACHE_L1DRM,
     .attrType = PERF_TYPE_HW_CACHE,
     .attrConfig = (PERF_COUNT_HW_CACHE_L1D) |
                   (PERF_COUNT_HW_CACHE_OP_READ << 8) |
                   (PERF_COUNT_HW_CACHE_RESULT_MISS << 16)},
    {.type = VIR_PERF_EVENT_CACHE_L1DWA,
     .attrType = PERF_TYPE_HW_CACHE,
     .attrConfig = (PERF_COUNT_HW_CACHE_L1D) |
                   (PERF_COUNT_HW_CACHE_OP_WRITE << 8) |
                   (PERF_COUNT_HW_CACHE_RESULT_ACCESS << 16)},
    {.type = VIR_PERF_EVENT_CACHE_L1DWM,
     .attrType = PERF_TYPE_HW_CACHE,
     .attrConfig = (PERF_COUNT_HW_CACHE_L1D) |
                   (PERF_COUNT_HW_CACHE_OP_WRITE << 8) |
                   (PERF_COUNT_HW_CACHE_RESULT_MISS << 16)},
    {.type = VIR_PERF_EVENT_CACHE_L1DPA,
     .attrType = PERF_TYPE_HW_CACHE,
     .attrConfig = (PERF_COUNT_HW_CACHE_L1D) |
